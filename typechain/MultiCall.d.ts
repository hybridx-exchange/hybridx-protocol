...
interface MultiCallInterface extends ethers.utils.Interface {
  functions: {
    ...
    "aggregateIgnoreFailed(tuple[])": FunctionFragment;
    "aggregateOnlyContract(tuple[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "aggregateIgnoreFailed",
    values: [{ target: string; callData: BytesLike }[]]
  ): string;
  encodeFunctionData(
    functionFragment: "aggregateOnlyContract",
    values: [{ target: string; callData: BytesLike }[]]
  ): string;
  encodeFunctionData(
...
export class MultiCall extends Contract {
  ...
  functions: {
    ...
    aggregateIgnoreFailed(
      calls: { target: string; callData: BytesLike }[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "aggregateIgnoreFailed(tuple[])"(
      calls: { target: string; callData: BytesLike }[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    aggregateOnlyContract(
      calls: { target: string; callData: BytesLike }[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "aggregateOnlyContract(tuple[])"(
      calls: { target: string; callData: BytesLike }[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;
