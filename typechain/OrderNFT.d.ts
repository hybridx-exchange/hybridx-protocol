...
interface OrderNFTInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "OrderUpdate(uint256,uint256,uint256,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "OrderUpdate"): EventFragment;
...
export class OrderNFT extends Contract {
  ...
  estimateGas: {
    ...
    get(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
